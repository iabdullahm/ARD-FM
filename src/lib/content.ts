export const content = {
  ar: {
    ...
    solution: {
      ...
      headline: 'رافد: مركز التحكم الذكي لعقاراتك',
    ...
    footer: {
      ...
      copyright: `© ${new Date().getFullYear()} رافد. جميع الحقوق محفوظة.`,
  ...
  en: {
    ...
    solution: {
      ...
      headline: 'Rafid: The Smart Hub for Your Properties',
    ...
    footer: {
      ...
      copyright: `© ${new Date().getFullYear()} Rafid. All rights reserved.`,
