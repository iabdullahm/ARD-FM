...
const STRINGS = {
  ar: {
    ...
    storySection: {
      ...
      content: [
        'بدأت رافد من رؤية بسيطة: جعل إدارة العقارات سهلة وفعّالة للجميع. مؤسسنا عبدالله الجهواري، برائد أعمال عماني بخبرة 10+ سنوات في التكنولوجيا والعقارات، رأى التحديات الكبيرة التي يواجهها مديرو العقارات.',
